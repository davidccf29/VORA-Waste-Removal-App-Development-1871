...
const Sidebar=()=> {
    ...
    switch (user?.role) {
      ...
      case 'administrator':
        return [
          ...
          {to: '/contractor-management',icon: FiTruck,label: 'Contractor Management'},
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200" style={{ position: 'relative', zIndex: 10 }}>
      <div className="p-6">
